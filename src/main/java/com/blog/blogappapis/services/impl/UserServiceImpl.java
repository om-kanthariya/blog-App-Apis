...
public class UserServiceImpl implements UserService {
	...
	public UserDto getUserById(Integer userId) {
		...
		User userb = this.userRepo.findById(userId).orElseThrow(()-> new ResourceNotFoundException("User","Id", userId));
		return this.userToDto(userb);
